...
public class MainWindow
   ...
   */
  public MainWindow() {
    //Do the Intialization Stuff here
  ...
  public void loadLoggedInFrame() {
      ...
      public void actionPerformed(ActionEvent e) {
        ...
        if (selectedItem != null) {
          ...
          if (startSipSession()) {
            ...
            JOptionPane.showMessageDialog(null, "No Peer Online Now" );
          }
    ...
    LoginWindow.getContentPane().setLayout(new FlowLayout());
    Dimension dim1 = new Dimension(330,500);
    ...
    this.addWindowListener(this);
    LoginWindow.setSize(dim1);
    LoginWindow.pack();
    LoginWindow.setVisible(true);
    LoginWindow.setSize(dim1);
    LoginWindow.setLocation(new Point(500, 80));
  }
  ...
  public void showNewChatWindow() {
    String user=MsrpStack.getLocalUser()+" - Chat Window";
    chatWindow = new ChatWindow(user);
    chatWindow.init();
    chatWindow.setSendReceieveWindow(true);
    chatWindow.setParent(this);
  }
